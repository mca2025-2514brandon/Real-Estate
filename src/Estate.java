/**
 * Represents a real estate property with details such as name, location, price, and ownership.
...
public class Estate extends Owner {
    ...
    private int price, duration, count = 0;

    /**
     * Constructs a new Estate object with the specified name, location, price, owner name, and phone number.
     *
